...
COmxILVideoSchedulerInputPort* COmxILVideoSchedulerInputPort::NewL(const TOmxILCommonPortData& aCommonPortData)
	...
	COmxILVideoSchedulerInputPort* self = new(ELeave) COmxILVideoSchedulerInputPort(aCommonPortData, supportedCodings, supportedColorFormats);
...
COmxILVideoSchedulerInputPort::COmxILVideoSchedulerInputPort(const TOmxILCommonPortData& aCommonPortData, 
...
void COmxILVideoSchedulerInputPort::ConstructL()
	{
	// Port definition mime type. Mime type is not relevant for uncompressed video frames
 	...
 	iParamVideoScheDropFrame.nPortIndex = iParamPortDefinition.nPortIndex;
