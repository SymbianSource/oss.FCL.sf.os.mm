...
private:
	/** A pointer to the VPB0Port. The ownership of the VPB0Port lies with this class. */
	COmxILGraphicSinkVPB0Port* ipb0Port;
	/** A pointer to the processing function. The ownership of the processing function lies with this class. */
	COmxILGraphicSinkProcessingFunction* ipGraphicSinkProcessingFunction;
	};
