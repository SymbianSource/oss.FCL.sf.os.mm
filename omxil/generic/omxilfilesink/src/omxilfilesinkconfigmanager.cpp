...
COmxILFileSinkConfigManager* COmxILFileSinkConfigManager::NewL(
	...
	{
	COmxILFileSinkConfigManager* self = new(ELeave) COmxILFileSinkConfigManager(aPortManager, aFileSinkPF);
...
COmxILFileSinkConfigManager::COmxILFileSinkConfigManager(MOmxILPortManagerIf& aPortManager, COmxILFileSinkProcessingFunction& aFileSinkPF)
