...
#include "OmxILAdPcmDecoderConverter.h"
...
*
*/
void TOmxILAdPcmDecoderConverter::Convert(TUint8* aSrc, TUint8* aDst, TInt aSamples)
	{
...
const TInt TOmxILAdPcmDecoderConverter::KIndexTable[] =
 	{
    -1, -1, -1, -1, 2, 4, 6, 8,
    -1, -1, -1, -1, 2, 4, 6, 8
	};

const TInt TOmxILAdPcmDecoderConverter::KStepSizeTable[89] = 
	{
