...
public:
	...
	virtual	TBool MosGetFilename(const TDesC8& aComp, TDesC& aFilename) = 0;
	...
	virtual TBool MosSetAudioPortDefL(const TDesC8& aComp, TInt aPortIndex, OMX_AUDIO_CODINGTYPE* aCodingType) = 0;
